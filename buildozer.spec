...
source.include_exts =pyaudiogaming

# (list) List of inclusions using pattern matching
#source.include_patterns = t.wav
...
requirements = python3,pygame,pycryptodome,plyer,cryptography,platform_utils,libloader,polib,pywin32,pywin32-ctypes,requests,urllib3
